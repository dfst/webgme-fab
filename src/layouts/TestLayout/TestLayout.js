...
define([
    ...
    'js/logger',
    'text!./templates/TestLayout.html',
    ...
    var TestLayout = function(params) {
        this._logger = (params && params.logger) || Logger.create('gme:Layouts:TestLayout',
     ...
     * @return {undefined}
     */
    TestLayout.prototype.init = function() {
        var self = this;
     ...
     * @return {undefined}
     */
    TestLayout.prototype.addToContainer = function(panel, container) {
        if (container === 'header') {
     ...
     * @return {undefined}
     */
    TestLayout.prototype.remove = function(panel) {
     ...
     * @return {undefined}
     */
    TestLayout.prototype.destroy = function() {
        this._body.empty();
    };
    ...
    TestLayout.prototype._onCenterResize = function() {
        if (this._canvas) {
